...
//             if(!carList.Contains(carIndex))
//                 carList.Add(carIndex); 
//         }
//         foreach (int number in carList)  
//         {  
//             DeleteMarkManager.SendMessage(false, number);
//             Debug.Log(number); 
//         }  
//         carList.Clear(); 
...
//                 personIndex++;
//             }
//             if(!personListList.Contains(personIndex))
//                 personList.Add(personIndex); 
//         }
//         foreach (int number in personList)  
//         {  
//             DeleteMarkManager.SendMessage(false, number);
//             Debug.Log(number); 
//         }  
